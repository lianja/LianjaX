...
proc lianjademo_section1 
	...
	page21.addobject(vSplitter)
	vSplitter.show
	
	Splitter_left = createobject("container")
	splitter_left.backcolor = rgb(255, 0, 255)
	Splitter_left.width = 300
	vSplitter.addobject(splitter_left)
	splitter_left.show
	...
	Splitter2.width = 600
	vsplitter.addobject(Splitter2)
	Splitter2.show
	
	Splitter2_left = createobject("container")
	splitter2_left.backcolor = rgb(0, 255, 255)
	Splitter2_left.width = 400
	splitter2_left.show
	Splitter2.addobject(splitter2_left)
	
	Splitter2_right = createobject("container")
	splitter2_right.backcolor = rgb(255, 255, 0)
	Splitter2_left.width = 400
