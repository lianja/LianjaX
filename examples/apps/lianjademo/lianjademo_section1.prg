...
proc lianjademo_section1 
	...
	// etc...
	//grid.addItems("select * from customers")
	...
	oOptiongroup.caption = "Optiongroup"
	oOptiongroup.top = 20
	oOptiongroup.left = 20
	oOptiongroup.width = 200
	oOptiongroup.height = 100
	oOptiongroup.tooltiptext = "Optiongroup"
	//Optiongroup.message = "Optiongroup"
	oOptiongroup.show
	page15.addobject(oOptiongroup)
	ooptiongroup.buttoncount = 2
	
	oOptiongroup.buttons(1).caption = "OptionButton1"
	oOptiongroup.buttons(1).show
	oOptiongroup.buttons(2).caption = "OptionButton2"
	oOptiongroup.buttons(2).show
	oOptiongroup.value = 2
	...
	// Splitter
	pagecont = createobject("container")
	pagecont.backcolor = "black"
	pagecont.autosize = .t.
	pagecont.show
	pagecont.layout = "V"
	page21.addobject(pagecont)

	vSplitter = createobject("Splitter")
	vSplitter.orientation = 0
	vSplitter.autosize = .t.
	vSplitter.show
	pagecont.addobject(vSplitter)
	vSplitter.backcolor = "red"
	
	Splitter_hleft = createobject("container")
	splitter_hleft.backcolor = "pink"
	splitter_hleft.show
	splitter_hleft.layout = "V"
	vSplitter.addobject(splitter_hleft)
	
	Splitter_hright = createobject("container")
	Splitter_hright.backcolor = "blue"
	Splitter_hright.show
	Splitter_hright.layout = "V"
	Splitter_hright.autosize = .t.
	vSplitter.addobject(Splitter_hright)

	// Splitter
	Splitter2 = createobject("Splitter")
	Splitter2.orientation = 1
	Splitter2.autosize = .t.
	Splitter2.show
	Splitter_hright.addobject(Splitter2)
	Splitter2.backcolor = "green"
	
	Splitter2_top = createobject("container")
	Splitter2_top.backcolor = rgb(0, 255, 255)
	Splitter2.addobject(Splitter2_top)
	Splitter2_top.show
	
	Splitter2_bottom = createobject("container")
	Splitter2_bottom.backcolor = rgb(255, 255, 0)
	Splitter2_bottom.show
	Splitter2.addobject(Splitter2_bottom)
